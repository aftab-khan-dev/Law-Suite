...
const EasySteps = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-[#E8BF78] to-[#F3D8A8] py-10 flex items-center justify-center ">
      <div className="flex flex-col md:flex-row rounded-lg  md:p-0 max-w-[89rem] w-full ">
        {/* Left Section - Image Slider */}
        <div className="w-full md:w-4/5 flex justify-center items-center  rounded-lg relative">
          {steps.length > 0 && (
            <img
          ...
          {/* <button
            ...
            className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-gray-700 bg-opacity-50 text-white p-2 rounded-full hover:bg-opacity-75 transition"
          ...
          <button
            onClick={nextSlide}
            className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-gray-700 bg-opacity-50 text-white p-2 rounded-full hover:bg-opacity-75 transition"
        ...
        <div className="w-full md:w-1/2 mt-8 md:mt-0 md:ml-8">
          <h2 className="text-3xl md:text-5xl font-bold text-[#3D4C57]">
            ...
            <span className="text-white">Trusted Lawyers</span>
          </h2>
